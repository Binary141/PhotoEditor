...
/**
 * @brief Takes care of all mutex needed for threading
 * Takes care of all mutex needed for threaded
 */
class ThreadedVector  // Takes care of all the mutex needed for this
{
  public:
